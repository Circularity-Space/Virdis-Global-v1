...
def get_top_10():
    ...
    client = pymongo.MongoClient('mongodb://codem:1100111@virdismart.nx3p6.mongodb.net/Virdsmart?retryWrites=true&w=majority&connect=false')
...
def download_file(request):
    ...
    fl_path = str(settings.MEDIA_ROOT)+"/mobile/"
    filename = "Virdis.apk"
